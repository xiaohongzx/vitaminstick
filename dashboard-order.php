        ...
        <div class="dashboard">
            <div class="dashcover">
                ...
                <div class="content">
                    <div class="orders">
                        <div class="tab">
                            <a href="https://www.party8.my/dashboard-order.html" class="active">All</a>
                            <a href="https://www.party8.my/dashboard-order-pending.html">To pay</a>
                            <a href="https://www.party8.my/dashboard-order-ship.html">To Ship</a>
                            <a href="https://www.party8.my/dashboard-order-complete.html">Complete</a>
                            <a href="https://www.party8.my/dashboard-order-cancel.html">Cancelled</a>
                        </div>
                        <div class="list">
                            <div class="box pending">
                                <div class="date">
                                    <div>Order Date: 06-12-2024 01:31pm</div>
                                ...
                                <div class="fee">
                                    <div class="text">
                                        <div class="ship">
                                            Subtotal : <span>RM120.00</span><br>
                                            Shipping Fees : <span>RM5.83</span>

                                        </div>

                                        <div class="total">

                                            Total : <span>RM125.83</span></div>
                                    </div>
                                    <div class="action">
                                        <a href="https://www.party8.my/dashboard-order-detail-7044E8021.html"
                                            class="view">View Detail</a>

                                        <form action="https://pay.merchant.razer.com/RMS/pay/partysciencesdn/"
                                            method="POST">
                                            <input type="hidden" name="amount" value="125.83">
                                            <input type="hidden" name="orderid" value="P8-OTPe9s1733419898">
                                            <input type="hidden" name="bill_name" value="azan123">
                                            <input type="hidden" name="bill_email" value="tmaxhong01@gmail.com">
                                            <input type="hidden" name="bill_mobile" value="+600123456789">
                                            <input type="hidden" name="bill_desc" value="One Time Purchase">
                                            <input type="hidden" name="country" value="MY">
                                            <input type="hidden" name="vcode" value="d12eb9d29045e8b0cdd7e96a1232482f">
                                            <input type="hidden" name="returnurl"
                                                value="https://www.party8.my/transaction-process.html">
