                ...
                <div class="content">
                    <div class="account">
                        <div class="title">
                            ...
                            <a href="dashboard-edit.php"><i class="iconmoon icon-modify"></i>Edit Profile</a>
                        </div>
                        <div class="profile">
                            <div class="row">
                                <div>Name</div>
                                <span>Christine Lee Ping Yu</span>
                            </div>
                            <div class="row">
                                <div>Email</div>
                                <span>chris_95@hotmail.com</span>
                            </div>
                            <div class="row">
                                <div>Country</div>
                                <span>Malaysia</span>
                        ...
                        <div class="title">
                            Credit Card for Subscription Package
                            <a href="dashboard-add-creditcard.php"><i class="iconmoon icon-add"></i>Add Card</a>
                        </div>
                        <div class="shipping">
                            <div class="empty">You have no saved credit card</div>
                            <div class="list">
                                <div class="adbox default">
                                    <div class="contact">
                                    ...
                                    <div class="action">
                                        <a href="#" class="modify"><i class="iconmoon icon-edit"></i></a>
                                        <a href="#" class="delete"><i class="iconmoon icon-delete"></i></a>
                                    </div>

                                    <div class="cta-address deletethis comfirmation" id="comfirmation2">
                                        <div class="content">
                                            <div>
                                                <p>Confirm Delete?</p>
                                                <form action="https://www.party8.my/a_process.php" method="post">
                                                    <div class="button">
                                                        <input type="hidden" name="a" value="del_address">
                                                        <input type="hidden" name="addressId" value="508FC23">
                                                        <input type="hidden" name="csrftoken"
                                                            value="MTcxMTQyMjMwMTYwMmE2YTc2ZDRmM2IxMzAxYmNkOGVmYTI4ZmNiY2U0MDU1N2E3ZjBoMHRvVGxsS1ZQdldlOXg3R1NZTE9xSmRaWldpaXNwaA==">
                                                        <input type="submit" class="sub" value="Yes">
                                                        <input type="button" class="cancel closethis" value="Cancel">
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                        ...
                        <div class="title">
                            Shipping Address
                            <a href="dashboard-add.php"><i class="iconmoon icon-add"></i>Add Address</a>
                        </div>
                        <div class="shipping">
                            <div class="empty">You have no saved address</div>
                            <div class="list">
                                <div class="adbox default">
                                    <div class="contact">
                                        <div>Wong Qian Shu</div>
                                        <span>(+60) 122346789</span>
                                    </div>
                                    <div class="address">
                                        3 No, Tower A Level 1-05 Vertical Business Suite Avenue 8,
                                        Jalan Kerinchi, <br>Bangsar South, 59200 Kuala Lumpur
                                    </div>
                                    <div class="default">Default</div>
                                    <div class="action">
                                        <a href="#" class="modify"><i class="iconmoon icon-edit"></i></a>
